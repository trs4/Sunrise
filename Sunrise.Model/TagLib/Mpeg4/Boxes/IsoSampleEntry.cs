...
public class IsoSampleEntry : Box
{
    ...
    /// <summary>Gets the data reference index of the current instance</summary>
    /// <value>A <see cref="ushort" /> value containing the data reference index of the current instance</value>
