...
public class IsoChunkLargeOffsetBox : FullBox
{
    ...
    /// <summary>Gets the offset table contained in the current instance</summary>
    /// <value>A <see cref="ulong[]" /> containing the offset table contained in the current instance</value>
