...
/// <summary>This class extends <see cref="Box" /> to provide an implementation of a ISO/IEC 14496-12 FullBox</summary>
public abstract class FullBox : Box
{
    /// <summary>Contains the box version</summary>
    private byte _version;

    /// <summary>Contains the box flags</summary>
    private uint _flags;
        ...
        : base(header, handler)
    {
        ...
        _version = header_data[0];
        _flags = header_data.Mid(1, 3).ToUInt();
    }
    ...
    /// <summary>Gets and sets the version number of the current instance</summary>
    /// <value>A <see cref="byte" /> value containing the version number of the current instance</value>
    public uint Version
    {
        get => _version;
    ...
    /// <value>A <see cref="uint" /> value containing the flags that apply to the current instance</value>
    public uint Flags
    {
        get => _flags;
        set => _flags = value;
    ...
    {
        var output = new ByteVector(_version)
        {
            ByteVector.FromUInt(_flags).Mid(1, 3),
            topData
        };
