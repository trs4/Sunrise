...
/// <summary>This class extends <see cref="FullBox" /> to provide an implementation of an Apple DataBox</summary>
public class AppleDataBox : FullBox
{
    /// <summary>Specifies the type of data contained in a box</summary>
    public enum FlagType
    {
        /// <summary>The box contains UTF-8 text</summary>
        ContainsText = 0x01,

        /// <summary>The box contains binary data</summary>
        ContainsData = 0x00,

        /// <summary>The box contains data for a tempo box</summary>
        ForTempo = 0x15,
