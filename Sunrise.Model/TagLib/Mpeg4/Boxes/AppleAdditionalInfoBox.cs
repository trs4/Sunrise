...
/// <summary>This class extends <see cref="Box" /> to provide an implementation of an Apple AdditionalInfoBox</summary>
public class AppleAdditionalInfoBox : Box
{
    /// <summary>Contains the box data</summary>
    ...
    /// <summary>Constructs and initializes a new instance of <see cref="AppleAdditionalInfoBox" /> using specified header, version and flags</summary>
    ...
    /// <summary>Gets and sets the text contained in the current instance</summary>
    /// <value>A <see cref="string" /> object containing the text contained in the current instance</value>
    public string? Text
    {
