...
public class UserTextInformationFrame : TextInformationFrame
{
    ...
    public override string ToString()
        => new StringBuilder().Append('[').Append(Description).Append("] ").Append(base.ToString()).ToString();
    ...
    public static UserTextInformationFrame? Get(Tag tag, string description, StringType type, bool create) => Get(tag, description, type, create, true);

    public static UserTextInformationFrame? Get(Tag tag, string description, bool create) => Get(tag, description, Tag.DefaultEncoding, create);
}
