...
{
    /// <summary>Checks if the buffer passed in is entirely full of nulls</summary>
    ...
    /// <summary>Converts to a string containing the buffer described in hex</summary>
    ...
    /// <summary>Decodes the buffer using the specified encoding, stopping at the first null</summary>
    ...
    /// <summary>Concatenates the given arrays into a single array</summary>
