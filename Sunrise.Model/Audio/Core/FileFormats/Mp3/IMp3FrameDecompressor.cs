...
/// <summary>Interface for MP3 frame by frame decoder</summary>
public interface IMp3FrameDecompressor : IDisposable
{
    /// <summary>Decompress a single MP3 frame</summary>
    ...
    /// <summary>Tell the decoder that we have repositioned</summary>
    void Reset();

    /// <summary>PCM format that we are converting into</summary>
