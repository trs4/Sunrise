...
/// <summary>Summary description for MmException</summary>
public class MmException : Exception
{
    /// <summary>Creates a new MmException</summary>
    ...
    /// <summary>Returns the Windows API result</summary>
    public MmResult Result { get; }

    /// <summary>The function being called</summary>
    public string Function { get; }

    /// <summary>Helper function to automatically raise an exception on failure</summary>
