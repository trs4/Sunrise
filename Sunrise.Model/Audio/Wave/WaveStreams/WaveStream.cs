...
/// <summary>Base class for all WaveStream classes. Derives from stream</summary>
public abstract class WaveStream : Stream, IWaveProvider
{
    /// <summary>Retrieves the WaveFormat for this stream</summary>
    public abstract WaveFormat WaveFormat { get; }

    /// <summary>We can read from this stream</summary>
    public override bool CanRead => true;

    /// <summary>We can seek within this stream</summary>
    public override bool CanSeek => true;

    /// <summary>We can't write to this stream</summary>
    ...
    /// <summary>Sets the length of the WaveStream. Not Supported</summary>
    ...
    /// <summary>Moves forward or backwards the specified number of seconds in the stream</summary>
    ...
    /// <summary>The current position in the stream in Time format</summary>
    ...
    /// <summary>Total length in real-time of the stream (may be an estimate for compressed files)</summary>
    public virtual TimeSpan TotalTime => TimeSpan.FromSeconds((double)Length / WaveFormat.AverageBytesPerSecond);

    /// <summary>Whether the WaveStream has non-zero sample data at the current position for the specified count</summary>
