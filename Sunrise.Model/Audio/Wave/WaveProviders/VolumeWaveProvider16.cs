...
/// <summary>Helper class allowing us to modify the volume of a 16 bit stream without converting to IEEE float</summary>
public class VolumeWaveProvider16 : IWaveProvider
{
    private readonly IWaveProvider _sourceProvider;

    /// <summary>Constructs a new VolumeWaveProvider16</summary>
    ...
    /// <summary>WaveFormat of this WaveProvider</summary>
    public WaveFormat WaveFormat => _sourceProvider.WaveFormat;

    /// <summary>Read bytes from this WaveProvider</summary>
