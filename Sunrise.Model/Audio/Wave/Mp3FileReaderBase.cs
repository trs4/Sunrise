...
/// <summary>Class for reading from MP3 files</summary>
public class Mp3FileReaderBase : WaveStream
{
    ...
    /// <summary>The MP3 wave format (n.b. NOT the output format of this stream - see the WaveFormat property)</summary>
    ...
    /// <summary>Opens MP3 from a stream rather than a file. Will not dispose of this stream itself</summary>
    ...
    protected Mp3FileReaderBase(Stream inputStream, FrameDecompressorBuilder frameDecompressorBuilder, bool ownInputStream)
    {
        ...
        _ownInputStream = ownInputStream;
        ...
        try
        {
            ...
            var firstFrame = Mp3Frame.LoadFromStream(_mp3Stream) ?? throw new InvalidDataException("Invalid MP3 file - no MP3 Frames Detected");
            ...
            if (secondFrame is not null
                && (secondFrame.SampleRate != firstFrame.SampleRate || secondFrame.ChannelMode != firstFrame.ChannelMode))
            {
    ...
    /// <summary>Function that can create an MP3 Frame decompressor</summary>
    ...
    private void CreateTableOfContents()
    {
        ...
        catch (EndOfStreamException) { } // not necessarily a problem
    }
    ...
    /// <summary>Gets the total length of this file in milliseconds</summary>
    private double TotalSeconds() => (double)_totalSamples / Mp3WaveFormat.SampleRate;

    /// <summary>ID3v2 tag if present</summary>
    public Id3v2Tag? Id3v2Tag { get; }

    /// <summary>ID3v1 tag if present</summary>
    public byte[] Id3v1Tag { get; }

    /// <summary>Reads the next mp3 frame</summary>
    ...
    private Mp3Frame? ReadNextFrame(bool readData)
    {
        ...
        catch (EndOfStreamException) { } // suppress for now - it means we unexpectedly got to the end of the stream half way through
    ...
    /// <summary><see cref="WaveStream.WaveFormat"/></summary>
    public override WaveFormat WaveFormat => _waveFormat;

    /// <summary><see cref="Stream.Position"/></summary>
    public override long Position
    {
        ...
        set
        {
            lock (_repositionLock)
            {
                ...
                if (_mp3Stream is not null)
                {
                    if (mp3Index is not null)
                    {
    ...
    public override int Read(byte[] sampleBuffer, int offset, int numBytes)
    {
        ...
        lock (_repositionLock)
        {
            ...
            while (bytesRead < numBytes)
            {
                ...
                if (frame is not null && _decompressor is not null)
                {
    ...
    /// <summary>Xing header if present</summary>
