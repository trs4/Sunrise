...
/// <summary>Interop definitions for Windows ACM (Audio Compression Manager) API</summary>
internal class AcmInterop
{
    ...
    [DllImport("Msacm32.dll")]
    public static extern MmResult acmFormatEnum(IntPtr hAcmDriver, ref AcmFormatDetails formatDetails, AcmFormatEnumCallback callback,
        IntPtr instance, AcmFormatEnumFlags flags);
