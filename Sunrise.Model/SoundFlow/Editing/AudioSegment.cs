...
public class AudioSegment : IDisposable
{
    ...
    private static TimeSpan MapStretchedOffsetToEffectiveTimelineOffset(TimeSpan stretchedOffset, float speedFactor)
    {
    ...
    private static void ReverseBufferInterleaved(Span<float> buffer, int channels)
    {
